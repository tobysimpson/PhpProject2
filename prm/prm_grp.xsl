        ...
        <table>
            ...
            <xsl:for-each select="tbl[1]/row">
                ...
                <xsl:for-each select="//tbl[2]/row">
                    ...
                    <xsl:variable name="prcs" select="//tbl[4]/row[@grp_id = $grp/@grp_id][@prc_id = $prc/@prc_id]"/>
...
<!--                                            <xsl:when test="$row/@prm_cal=0">
                                            ...
                                            <!--<xsl:otherwise>-->
                                                <a href="prm.php?mth=hst&amp;prm_id={$row/@prm_id}&amp;xsl=1">
                                                    <!--<img src="prm.php?mth=prv&amp;res_id={$res/@res_id}&amp;prm_id={$row/@prm_id}&amp;xsl=1"/>-->
                                                    <img src="prm.php?mth=hpr&amp;prm_id={$row/@prm_id}&amp;xsl=1"/>
                                                </a>
<!--                                            </xsl:otherwise>
                                        </xsl:choose>-->
                                    </xsl:if>
