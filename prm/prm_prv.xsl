    ...
    <xsl:template match="root">
        <svg width="{$w}" height="{$h}" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <g id="txt" transform="translate(0,0)">
                <text x="{$w * 0.99}" y="{$h * 0.3}" alignment-baseline="middle" text-anchor="end" font-family="sans-serif" font-weight="400" font-size="8pt" fill="#6666FF">
                    <xsl:value-of select="format-number(tbl[3]/row[last()]/@tj,'#,##0.00')"/>
                </text>
                <text x="{$w * 0.99}" y="{$h * 0.5}" alignment-baseline="middle" text-anchor="end" font-family="sans-serif" font-weight="400" font-size="8pt" fill="#FF6666">
                    <xsl:value-of select="format-number(tbl[2]/row[1]/@reg_b,'#,##0.00')"/>
                </text>
                <text x="{$w * 0.99}" y="{$h * 0.7}" alignment-baseline="middle" text-anchor="end" font-family="sans-serif" font-weight="400" font-size="8pt" fill="#006600">
